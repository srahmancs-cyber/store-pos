        ...
        <div class="card">
            <div class="card-body space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <input type="number" name="lead_time_days" class="form-input" min="1" max="365"
                            value="{{ old('lead_time_days') }}" placeholder="e.g. 7">
                    </div>
                ...
                <div>
                    ...
                    <textarea name="payment_terms" class="form-input" rows="2"
                        placeholder="e.g. Net 30 days">{{ old('payment_terms') }}</textarea>
                </div>
            </div>
        </div>
